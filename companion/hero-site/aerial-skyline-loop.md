# Website hero — Variant: aerial skyline (loop-friendliest)

- **Usage**: homepage background candidate designed for a seamless loop — no vehicles,
  no train, only slow cloud drift. Least distracting option behind title + CTA.
- **Model**: Seedance 2.0
- **Format**: 16:9 · 8 s · fixed shot · loop
- **Validation**: watch the loop seam — only clouds and their shadows should move.
