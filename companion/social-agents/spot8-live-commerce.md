# Agent social spot 8 — "LIVE ขายห้อง" (Real Thai style, 2×8 s)

- **Style**: `real-thai-style.md` episode 1 — the ad camouflaged as a live-commerce
  stream, THE commercial culture of Thai 20–30s. P'Fon sells a condo exactly the
...
- **Post**: generic live-stream UI overlay (floating hearts, chat spamming "1",
  ...
  ```
  นิวาส คอมแพเนียน — สต็อกเรียลไทม์ เร็วกว่าไลฟ์
  ```
  *"Nivas Companion — real-time stock, faster than a live"* + logo + QR.
...
```
Clip 1: ห้องนี้วิวแม่น้ำ!! เหลือห้องเดียวค่ะ!! พิมพ์ 1 ในแชทเลย!! วันนี้จัดส่งฟรี!!
Clip 2: อ้าว… มีคนจองไปแล้วค่ะ (beat) ใช่ค่ะ นี่คือโฆษณา — สต็อกเรียลไทม์ มันเร็วแบบนี้แหละค่ะ
```
*Clip 1: "River view!! Only ONE unit left!! Type 1 in the chat!! Today: free
delivery!!" — Clip 2: "Oh… someone already booked it. (beat) Yes, this is an ad —
real-time stock really is this fast."*
