# Agent social spot — Clip 1/3: the chaos (motosai)

- **Usage**: first clip of the classic TVC structure chaos → twist → payoff.
  9:16 spot for Facebook / TikTok / Reels targeting Bangkok freelance agents.
- **Recurring heroine**: "P'Fon" — Thai agent ~30, light blazer + sneakers,
  the credible archetype of the freelance condo agent. **Keep her identical across
  all 3 clips.**
- **Model**: Seedance 2.0 (no on-screen dialogue) — or Kling 3.0 if she speaks on camera
...
```
ห้องนี้… ว่างมั้ยนะ… เดี๋ยวเช็คก่อนนะคะ!
```
*"This unit… is it still free?… let me check right away!"*
