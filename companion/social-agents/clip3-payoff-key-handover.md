# Agent social spot — Clip 3/3: the payoff (key handover)

- **Usage**: final feel-good clip + end card. Closes the chaos → twist → payoff structure.
- **Model**: Seedance 2.0
- **Format**: 9:16 · 8 s · continuous shot
- **Post-production**: end card to edit in after the wink (never generated):

  ```
  นิวาส คอมแพเนียน — สต็อกห้องของคุณ ครบ จบ ในมือถือ
  ```
  *"Nivas Companion — your room stock, complete, done, on your phone"*
