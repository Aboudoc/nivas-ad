# Agent social spot 2 — Clip 2/3: the horror parody

- **Concept**: same living room, but suddenly graded like a Thai horror movie —
  the over-the-top swerve that makes Thai ads go viral. Comedic, never actually scary.
- **Model**: Seedance 2.0 · **Format**: 9:16 · 8 s · continuous shot
- **Continuity**: same P'Fon + same sweaty rival agent + both client couples as clip 1.
- **Post-production**: deep horror-trailer Thai VO (line below), thunder SFX,
...
```
ฝันร้ายที่เอเจนท์ทุกคนต้องเจอ…
```
*"The nightmare every agent has to face…"*
