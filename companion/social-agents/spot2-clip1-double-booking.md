# Agent social spot 2 — Clip 1/3: the double booking (setup)

- **Concept**: "the agent's nightmare" — a Thai horror-movie parody of the double
  booking, the pain Nivas Companion kills. Structure: setup → horror parody →
  saved by real-time stock. Classic buzz-making Thai TVC genre (comedy that swerves
  into fake horror and back).
- **Recurring heroine**: P'Fon (same as spot 1 — reuse her face reference frame).
  The rival agent: sweaty man in a crumpled shirt (the archetype from the hero
  HUMOUR version 1).
- **Model**: Seedance 2.0 · **Format**: 9:16 · 8 s · continuous shot
- **Grade**: bright "Thai TVC" daylight — the contrast with clip 2 IS the joke.
- **Post-production**: real Thai VO + burned-in Thai subtitles.
...
```
P'Fon: ห้องนี้เพิ่งว่างเลยค่ะ!
Both agents together: อ้าว!?
```
*P'Fon: "This unit just became available!" — Both agents: "Huh?!"*
